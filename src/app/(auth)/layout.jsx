    ...
    <div className="grid grid-cols-1 min-h-screen flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)]">
      <div className="flex flex-col px-5 py-6 md:px-12 md:py-10">
        ...
        <p className="text-xs text-neutral-600">
          © {site.name}. Demo trading platform · <Link href="/legal/risk" className="text-neutral-400">Risk disclosure</Link>
        </p>
      </div>
      <aside className="relative hidden overflow-hidden border-l border-white/10 bg-black lg:block">
        ...
        <div className="absolute inset-x-12 bottom-14">
          <p className="font-heading text-4xl leading-tight font-bold tracking-tight text-white">{site.tagline}</p>
