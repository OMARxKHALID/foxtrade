...
export const ConfirmDialog = ({ open, onOpenChange, title, description, confirmLabel = "Confirm", tone = "orange", reasonLabel, pending, onConfirm }) => {
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Popup className="fixed top-1/2 left-1/2 z-50 w-[min(28rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/10 bg-panel p-6 shadow-[0_24px_60px_rgba(0,0,0,0.7)] outline-none">
          ...
          <div className="mt-6 flex justify-end gap-3">
            ...
            <GradientButton variant={tone} size="sm" onClick={handleConfirm} disabled={pending || (reasonLabel && reason.trim().length < 3)}>
