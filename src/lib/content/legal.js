export const legalPages = {
  ...
  privacy: {
    ...
    updated: "2026-09-01",
    sections: [
      { heading: "What we collect", text: "Email address, profile details you provide, verification documents you upload and activity within the platform." },
      { heading: "How we use it", text: "To operate your account, secure the platform and improve the product. We do not sell personal data." },
      { heading: "Your rights", text: "You can request a copy of your data or delete your account at any time from support." },
    ],
  },
  risk: {
